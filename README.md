...
Hand-set in HTML, CSS and vanilla JavaScript. No frameworks, no build step; the
core site makes zero external requests. Light and dark editions follow the
system theme with a persistent manual override. Reduced-motion is the default
stylesheet — all animation is layered on inside
